...
var triajData = [
    ...
    TriajData(image: "triaj7", title: "Totul pare in regula!", subViewType: .finish, subView: "Hello", actionType: .button, actionTitle: "Reda testul", actionForegorund: .white, actionColor: signatureDarkBlue, actionSize: actionNormal),
