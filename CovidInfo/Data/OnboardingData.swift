...
public var onboardingDataArray = [
    OnboardingData(lottieAnimation: "onboarding2", labelText: "Afla cum sa te protejezi si ce simptome pot aparea, ultimele stiri si de unde sa te informezi", isModalNext: false),
