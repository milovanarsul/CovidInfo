...
var triajData = [
    ...
    TriajData(image: "triaj3", title: "Care este varsta ta?", subViewType: .form, subView: ["Intre 18 si 65 de ani","Peste 65 de ani"], actionType: .none, actionSize: 20),
    TriajData(image: "triaj4", title: "In ultimele zile ai fost testat pentru COVID-19?", subViewType: .form, subView: ["Am fost testat si rezultatul este pozitiv", "Am fost testat si rezultatul este negativ", "Nu am fost testat in ultimele 10 zile"], actionType: .none, actionSize: 20),
